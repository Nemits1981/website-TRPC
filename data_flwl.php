...
$sql_flwl = "SELECT NO, PAPER_TYPE, WATERMARK,  WIDTH, LENGTH, QTY, UNIT FROM data_flwl";
$result_flwl = $conn->query($sql_flwl);
...
<h1>DATA FIRST LEAVES DAN WARNING LEAVES</h1>
<h2>Status : Data belum masuk</h2>
...
<table>
    ...
    <?php
       ...
       if ($result_flwl->num_rows > 0) {
           while($row = $result_flwl->fetch_assoc()) {
